...
public class LISTA_TIPIFICACION extends javax.swing.JFrame {
    ...
    public LISTA_TIPIFICACION() {
        ...
        TablaTipi.getTableHeader().setOpaque(false);
        TablaTipi.getTableHeader().setBackground(new Color(32,135,203));
        TablaTipi.getTableHeader().setForeground(new Color(32,135,203));
        TablaTipi.setRowHeight(25);
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 76, -1, 500));
